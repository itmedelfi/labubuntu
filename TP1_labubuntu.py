...
# Podemos ver en que provincia esta cada establecimientos medico pues en df_establecimientos_medicos contamos con el id del departamento
...
# lo unimos a la tabla df_provincias y listo
